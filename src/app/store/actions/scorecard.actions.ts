...
export const UPDATE_SCORECARD_SUCCESS = '[Scorecard] Update Scorecards Success';
...
export class UpdateScorecardSuccess implements Action {
  readonly type = UPDATE_SCORECARD_SUCCESS;
  constructor(public payload: Update<ScoreCard>) {}
}
