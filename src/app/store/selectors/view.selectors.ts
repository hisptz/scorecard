...
export const getScorecardToView = createSelector(getViewedState, createScorecardFromStore);
...
export const getScorecardId = createSelector(getScorecardToView, (data: ScoreCard) => data.id);

export const getCanEdit = createSelector(getScorecardToView, (data: ScoreCard) => data.can_edit);
