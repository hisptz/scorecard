...
export class DetailsComponent implements OnInit {
  ...
  constructor(
    ...
    this.analytics$ = this.store.select( selectors.getPreviewAnalytics );
    this.chartObject$ = this.store.select( selectors.getPreviewChart );
    this.tableObject$ = this.store.select( selectors.getSelectedPeriod );
    this.mapObjet$ = this.store.select( selectors.getPreviewMap );
  }
