  ...
  initiateItems() {
    ...
    this.dataElementService.loadAll().subscribe(
      ...
      error => {
        this._error_loading_groups$.next({
          occurred: true,
          message: 'There was an error when loading Data Elements'
        });
      }
    );
    // get Programs
    this.programService.loadAll().subscribe(
      ...
      error => {
        this._error_loading_groups$.next({
          occurred: true,
          message: 'There was an error when loading Programs'
        });
      }
    );
    // get datasets
    this.datasetService.loadAll().subscribe(
      ...
      error => {
        this._error_loading_groups$.next({
          occurred: true,
          message: 'There was an error when loading Data sets'
        });
      }
    );
    //  get functions
