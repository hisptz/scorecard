...
export default <IStepOption[]>[
  ...
  },
  {
    anchorId: 'view.print',
    content:
      'Click here to print scorecard, to see colors your printer should support colors',
    placement: 'left',
  ...
  },
  {
    anchorId: 'view.excel',
    content:
      'Click here to download scorecard as excel, you will not get the colors in the resulting file',
    placement: 'left',
