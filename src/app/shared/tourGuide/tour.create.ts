...
export default <IStepOption[]>[
  ...
  },
  {
    ...
    content:
      'These will be additional rows to add more information about your scorecard, eg. Source of data',
    placement: 'bottom',
  ...
  },
  {
    ...
    content:
      'Select the item to add it the scorecard, you can simply click it, drag it to the sample area, or right click to get more options',
    placement: 'bottom',
